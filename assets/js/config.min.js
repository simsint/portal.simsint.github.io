    ...
    getResponse(
      ...
      (data) => {
        ...
        if (form_type == "adult_form_ar") {
          ...
          $("#forms-data").html(ptRenderForm(data));
        }
        if (form_type != "adult_form_ar") {
          ...
          <div class="col">
              ...
              <div class="dropdown d-inline-block m-2">
                ...
                <div class="dropdown-menu text-capitalize">
                  <a class="dropdown-item" href="#" data-action="pt-report">Report</a>
