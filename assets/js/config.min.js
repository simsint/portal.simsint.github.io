...
function renderUserHtml(data) {
  ...
  <div class="col-12 collapse" id="collapse-${data.sub}">
      <div class="row mt-2">
          <div class="col-sm-12 col-md-6 text-center"><img class="img-fluid" src="${emiratesResolver(
            data.email
          )}" /></div>
          <div class="col-sm-12 col-md-6 text-center"><img class="img-fluid" src="${emiratesResolver2(
            data.phone_number
          )}" /></div>
      </div>
  </div>
...
function emiratesResolver(data) {
  if (data === "ykuk88@gmail.com") {
    return "./assets/img/emirids/eidf_1612582523905.jpeg";
  } else if (data === "sod@simsint.com") {
    return "./assets/img/emirids/eidf_1612582523906.jpeg";
  } else {
    return "./assets/img/card-holder.png";
  }
}
function emiratesResolver2(data) {
  if (data === "+971508444797") {
    return "./assets/img/emirids/eidb_1612582523905.jpeg";
  } else if (data === "+971585871430") {
    return "./assets/img/emirids/eidb_1612582523906.jpeg";
  } else {
    return "./assets/img/card-holder.png";
  }
}
...
function renderAppointmentHtml(event) {
  ...
  if (
    ...
    htmlContent += `<button class="btn btn-outline-primary action btn-sm m-1" type="button" data-action="confirm" data-eid='${event.id}' data-pid="${event?.extendedProperties?.private?.patient_id}" data-pt-mail="${event?.extendedProperties?.private?.patient_email}" data-doc-mail="${event?.extendedProperties?.private?.doctor_email}">CONFIRM</button>`;
  }
