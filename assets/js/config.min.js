...
function renderUserHtml(data) {
  ...
  <div class="col-12 collapse" id="collapse-${data.sub}">
      <div class="row mt-2">
        <div class="col-sm-12 col-md-6 text-center"><img class="img-fluid" style="height:100%" src="${
...
// $("#emirates_id_front_file").on("change", function (e) {
//   var selected_file_name = $(this).val();
//   if (selected_file_name.length > 0) {
//     /* Some file selected */
//     var reader = new FileReader();
...
// $("#emirates_id_back_file").on("change", function (e) {
//   var selected_file_name = $(this).val();
//   if (selected_file_name.length > 0) {
//     /* Some file selected */
//     var reader = new FileReader();
